...
void WorldExplorer::applyEnvironment(CellEnvironment cellEnvironment)
{
    ...
    if (current->cells.at(0) == nullptr) {
        ...
        if (explored.contains(pos)) {
            ...
            current->cells.at(0) = new ballistics_simulator::Cell{.position = pos, .type = cellEnvironment.cellTypes.at(0), .cells{}};
    ...
    if (current->cells.at(1) == nullptr) {
        ...
        if (explored.contains(pos)) {
            ...
            current->cells.at(1) = new ballistics_simulator::Cell{.position = pos, .type = cellEnvironment.cellTypes.at(1), .cells{}};
    ...
    if (current->cells.at(2) == nullptr) {
        ...
        if (explored.contains(pos)) {
            ...
            current->cells.at(2) = new ballistics_simulator::Cell{.position = pos, .type = cellEnvironment.cellTypes.at(2), .cells{}};
    ...
    if (current->cells.at(3) == nullptr) {
        ...
        if (explored.contains(pos)) {
            ...
            current->cells.at(3) = new ballistics_simulator::Cell{.position = pos, .type = cellEnvironment.cellTypes.at(3), .cells{}};
    ...
    if (current->cells.at(4) == nullptr) {
        ...
        if (explored.contains(pos)) {
            ...
            current->cells.at(4) = new ballistics_simulator::Cell{.position = pos, .type = cellEnvironment.cellTypes.at(5), .cells{}};
    ...
    if (current->cells.at(5) == nullptr) {
        ...
        if (explored.contains(pos)) {
            ...
            current->cells.at(5) = new ballistics_simulator::Cell{.position = pos, .type = cellEnvironment.cellTypes.at(6), .cells{}};
    ...
    if (current->cells.at(6) == nullptr) {
        ...
        if (explored.contains(pos)) {
            ...
            current->cells.at(6) = new ballistics_simulator::Cell{.position = pos, .type = cellEnvironment.cellTypes.at(7), .cells{}};
    ...
    if (current->cells.at(7) == nullptr) {
        ...
        if (explored.contains(pos)) {
            ...
            current->cells.at(7) = new ballistics_simulator::Cell{.position = pos, .type = cellEnvironment.cellTypes.at(8), .cells{}};
